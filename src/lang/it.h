...
// controls options
    ...
    , "Mira multipla"
    // controls
    , "Sinistra", "Destra", "Corsa", "Indietro", "Salto", "Cammina", "Azione", "Estrai l'Arma", "Guarda", "Accovacciati", "Scatto", "Capriola", "Inventario", "Start"
    , STR_KEYS
// inventory items
    , "Sconosciuto"
    , "Esplosivo"
...
// TR1 subtitles
    ...
    "[12500]Infrangendo le regole a cui il nostro popolo@deve sottostare per la sua sicurezza,"
    ...
    "[35500]Nessuno di voi possiede un briciolo@di inventiva nella sua testa."
    "[40500]Inetti!"
    ...
    "[43000]Troppo tardi per fallire adesso!"
